...
def main():
    ...
    plot_segmentation_with_accuracy_and_uncertainty(img, ground_truth, segmentation, accuracy_map, adjusted_uncertainty, slice_num, save_path=f"./figures/{case_num}_segmentation_plot.png")
