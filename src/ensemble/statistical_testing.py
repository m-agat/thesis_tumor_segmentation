...
t_stat, p_value = ttest_rel(performance_df_swinunetr['Composite_Score_1'], performance_df_segnet['Composite_Score_1'])
print(f"T-Test for NCR: t-statistic = {t_stat}, p-value = {p_value}")

# Wilcoxon signed-rank test for NCR
stat, p = wilcoxon(performance_df_swinunetr['Composite_Score_1'], performance_df_segnet['Composite_Score_1'])
print(f"Wilcoxon Test for NCR: statistic = {stat}, p-value = {p}")

t_stat, p_value = ttest_rel(performance_df_swinunetr['Composite_Score_2'], performance_df_segnet['Composite_Score_2'])
print(f"T-Test for ED: t-statistic = {t_stat}, p-value = {p_value}")

# Wilcoxon signed-rank test for NCR
stat, p = wilcoxon(performance_df_swinunetr['Composite_Score_2'], performance_df_segnet['Composite_Score_2'])
print(f"Wilcoxon Test for ED: statistic = {stat}, p-value = {p}")

# Paired t-test for NCR
t_stat, p_value = ttest_rel(performance_df_swinunetr['Composite_Score_4'], performance_df_segnet['Composite_Score_4'])
print(f"T-Test for ET: t-statistic = {t_stat}, p-value = {p_value}")

# Wilcoxon signed-rank test for NCR
stat, p = wilcoxon(performance_df_swinunetr['Composite_Score_4'], performance_df_segnet['Composite_Score_4'])
print(f"Wilcoxon Test for ET: statistic = {stat}, p-value = {p}")

# Calculate the performance difference
performance_diff_ncr = performance_df_swinunetr['Composite_Score_1'] - performance_df_segnet['Composite_Score_1']
