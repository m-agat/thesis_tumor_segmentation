...
# Paths
outputs_dir = "/mnt/c/Users/agata/Desktop/thesis_tumor_segmentation/src/uncertainty/outputs"
...
tc_metrics = {"Dice": [], "Composite_Score": [], "HD95": [], "F1": [], "Sensitivity": []}
wt_metrics = {"Dice": [], "Composite_Score": [], "HD95": [], "F1": [], "Sensitivity": []}
et_metrics = {"Dice": [], "Composite_Score": [], "HD95": [], "F1": [], "Sensitivity": []}
...
for _, row in performance_data.iterrows():
    ...
    hd95_ncr, hd95_ed, hd95_et = map(lambda x: safe_metric(row[x], default=1e6), ["HD95_1", "HD95_2", "HD95_4"])  # Use a large value for HD95
    ...
    if total_tc_count > 0:
        for metric, ncr, et in [
            ...
            weighted_tc_metric = (ncr * ncr_ratio + et * et_ratio) / (ncr_ratio + et_ratio)
    ...
    if total_wt_count > 0:
        for metric, ncr, ed, et in [
            ...
            weighted_wt_metric = (ncr * ncr_ratio + ed * ed_ratio + et * et_ratio) / (ncr_ratio + ed_ratio + et_ratio)
