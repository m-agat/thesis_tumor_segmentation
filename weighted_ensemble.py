...
def process_case(case_num, data_dir, results_dir, models, device, model_weights):
    ...
    Now includes model weights for the ensemble.
    """
    ...
    # Call the ensemble segmentation function with weights
    segmentation, variance_uncertainty, dice_uncertainty = get_weighted_ensemble_segmentation_with_uncertainty(
        models, test_loader, roi=(96, 96, 96), ground_truth=ground_truth, weights=model_weights
    )
