...
# Step 5: Create a Python environment for the experiment
env = Environment.from_pip_requirements("my_env", "./requirements_azure.txt")
...
src = ScriptRunConfig(
    ...
    environment=env,
    arguments=[
        '--config', 'config.yaml',  # Add config file
