...
brats_data_dir = '/home/agata/Desktop/thesis_tumor_segmentation/BraTS2024-BraTS-GLI-ValidationData/validation_data'
...
imagestr = os.path.join(out_base, "imagesTs")
# labelstr = os.path.join(out_base, "labelsTs")
